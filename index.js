...
//
const BotName = 'META BOTZ./GILANG-AD'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/_panggil_aku_gilang_/'; // Nama Instagramlu cok
const whatsapplu = '0822-2588-0439'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => META BOTZ by root@GILANG-AD`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => META BOTZ by root@GILANG-AD`)
})
...
axios.get(`https://mhankbarbar.herokuapp.com/nulis?text=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
    let hasil = `Download sendiri hasilnya dibawah tod, kalo dikirim langsung jadi burik kek muka lu...\n\n${res.data.result}`;
...
axios.get(`https://mhankbarbar.herokuapp.com/api/yta?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
    let hasil = `Download sendiri lewat link dibawah tod, jangan manja asw...\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, 'Waalaikumsalam, kenapa asw? kalo bingung ketik #help aja cok...' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, kenapa asw? kalo bingung ketik #help aja cok...' ,MessageType.text);
}
...
conn.sendMessage(id, 'Apa ajg?, kenapa asw? kalo bingung ketik #help aja cok...' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Apa ajg?, kenapa asw? kalo bingung ketik #help aja cok...' ,MessageType.text);
}
...
conn.sendMessage(id, 'i love u matamu cok!' ,MessageType.text);
}
else if (text == 'mas'){
conn.sendMessage(id, 'Apa ajg?, kenapa asw? kalo bingung ketik #help aja cok...' ,MessageType.text);
}
...
conn.sendMessage(id, 'Oke tod, jangan ganggu lagi asw :v' ,MessageType.text);
}
else if (text == 'Makasi'){
conn.sendMessage(id, 'Oke tod, jangan ganggu lagi asw :v' ,MessageType.text);
}
...
conn.sendMessage(id, 'bukan #stiker,tapi #sticker goblok :v' ,MessageType.text);
}
else if (text == 'Thanks'){
conn.sendMessage(id, 'Oke tod, jangan ganggu lagi asw :v' ,MessageType.text);
}
...
/*   if (text.includes("#yt"))
   ...
   {
    var items = ["ullzang girl", "cewe cantik", "hijab cantik"];
